  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white border-b border-gray-100 h-16 flex items-center px-8 justify-between">
        <span className="font-bold text-gray-900">AssistMed AI</span>
      ...
      <main className="flex-1 max-w-4xl mx-auto p-8 space-y-8">
        ...
        <section className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-4">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            La inteligencia artificial (IA) integrada en AssistMed AI **NO genera diagnósticos médicos reales ni prescribe tratamientos** de forma Autónoma. 
        ...
        <section className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-4">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            Todos los derechos de software, interfaces, algoritmos de sugerencia AI, y arquitectura del sistema de **AssistMed AI** pertenecen a sus creadores. Queda estrictamente prohibida la copia, reproducción, redistribución o ingeniería inversa de cualquier componente del sistema sin una autorización expresa por escrito.
          </p>
        </section>
      ...
      <footer className="h-16 border-t border-gray-100 bg-white flex items-center justify-center text-xs text-gray-400">
        &copy; {new Date().getFullYear()} AssistMed AI. Todos los derechos reservados.
      </footer>
    </div>
  );
}
