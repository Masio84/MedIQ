      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-8 shrink-0">
          <div className="flex items-center gap-3">
            <button 
              className="p-2 -ml-2 rounded-lg text-gray-500 hover:bg-gray-50 md:hidden animate-pulse"
              onClick={toggleSidebar}
            >
              <Menu size={22} />
            </button>
            <h2 className="text-xs md:text-sm font-medium text-gray-400">Sistema Beta AssistMed AI</h2>
          </div>
          {profile?.avatar_url && (
