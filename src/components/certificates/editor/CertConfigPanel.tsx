              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                ...
                <div className="flex flex-col bg-gray-50 p-2 rounded-lg col-span-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-[9px] font-mono font-bold text-gray-600 w-6 text-right">{template.branding.signature?.offsetY || 0}</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="flex flex-col bg-gray-50 p-2 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    <input 
                      ...
                      className="flex-1 accent-blue-600 h-1"
                      value={template.branding.seal?.rotation || 0}
                      onChange={(e) => handleSealUpdate('rotation', parseInt(e.target.value))}
                    />
